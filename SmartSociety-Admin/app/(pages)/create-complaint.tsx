...
import { checkActiveCategoryComplaint, createComplaint } from '../../src/services/complaint.service';
import { BorderRadius, Colors, Shadows, Spacing, Typography } from '../../src/theme';
import { ComplaintCategories, ComplaintCategory } from '../../src/types/complaint.types';
...
export default function CreateComplaintScreen() {
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true);
    try {
      // Check if user already has an active complaint for this category
      const hasActiveComplaint = await checkActiveCategoryComplaint(user.uid, selectedCategory);
      
      if (hasActiveComplaint) {
        Alert.alert(
          'Active Complaint Exists',
          `You already have an active complaint for ${ComplaintCategories[selectedCategory].label}. Please wait for it to be resolved before submitting a new one.`
        );
        setIsLoading(false);
        return;
      }
      ...
      Alert.alert(
        'Success',
        'Your complaint has been submitted successfully. You will be notified when the admin responds.',
        [
          {
            text: 'OK',
            onPress: () => router.back(),
      ...
      >
        <SafeAreaView edges={['top']}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Lodge Complaint</Text>
